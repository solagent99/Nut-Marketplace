...
import { NutMarketplace } from "../target/types/nut_marketplace";
...
const program = anchor.workspace.NutMarketplace as Program<NutMarketplace>;
...
describe("Nut_Marketplace Load Program Object & Prepare testers", () => {
